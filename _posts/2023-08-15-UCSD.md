...
We also aimed to conceptually relate our approach to ideas explored in  
*Learning Vision-Guided Quadrupedal Locomotion End-to-End with Cross-Modal Transformers* (arXiv:2107.03996), but using a more traditional, modular robotics pipeline.
